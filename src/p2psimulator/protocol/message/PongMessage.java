...
public class PongMessage extends Message {
  ...
  public PongMessage(int sender, int receiver, double timestamp) {
    this.sender = sender;
    this.receiver = receiver;
    this.timeStamp = timestamp;
    this.msgType = MessageConstants.PONG;
  }
 ...
 public String msgString() {
   return (new String("Node "+this.sender+": at time "+this.timeStamp+" sending <PONG> to "+this.receiver));
 }
}