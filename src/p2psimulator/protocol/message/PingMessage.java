...
public class PingMessage extends Message {
  ...
  public PingMessage(int sender, int receiver, double timestamp) {
    this.sender = sender;
    this.receiver = receiver;
    this.timeStamp = timestamp;
    this.msgType = MessageConstants.PING;
  }
 ...
 public String msgString() {
   return (new String("Node "+this.sender+": at time "+this.timeStamp+" sending <PING> to "+this.receiver));
 }
}